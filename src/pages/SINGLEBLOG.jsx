    ...
    const fetchSingleBlog = async () => {
      try {
        const response = await axios.get(
          `https://blog-app-3-0mfy.onrender.com/api/v1/blogs/${id}` // dynamic id
        );
        ...
        <div className="bg-pink-300 rounded-lg shadow-md p-8">
          ...
          <div className="mb-b">
            ...
            <div className="flex justify-between items-center text bg-purple-200 mb-6">
              ...
              <button
                className="bg-amber-300 text-red-600 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-amber-200 transition-colors"
